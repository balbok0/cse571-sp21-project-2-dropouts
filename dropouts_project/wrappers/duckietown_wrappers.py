"""
Wrappers adopted from: https://github.com/duckietown/gym-duckietown/blob/daffy/learning/utils/wrappers.py
With slight modifications to avoid depracation.
"""
...
class ResizeWrapper(gym.ObservationWrapper):
    ...
    def observation(self, observation):
        result = np.array(Image.fromarray(observation).resize((self.shape[1], self.shape[0])))
        return result
